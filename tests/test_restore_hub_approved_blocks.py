...
class HubRecoveryRegression(unittest.TestCase):
    def test_only_three_authorized_regions_change(self):
        ...
        approved_early = '''<html><body><div id="principal-infographic"><figure><img src="assets/legacy-visual.webp"></figure></div><section id="stanley-update">''' + ''.join('<a href="https://example.com"><img src="assets/x.webp"></a>' for _ in range(13)) + ''.join('<a href="https://example.com">x</a>' for _ in range(4)) + '''</section></body></html>'''
        ...
        self.assertIn('assets/legacy/legacy-visual.webp', candidate)
